...
rule. Finally, we can choose a random cleavage configuration using the preconfigured division mode <i>Random</i>. 
        ...
        <div class="w3-code">
          ...
          <Typography paragraph>
            (1) For example, if <i>Threshold</i> = 0.85, it means that the actual area must reach an 85% of the target value.
            ...
            applies to the actual size of the cell and not simply to the preferred size as prescribed by the elastic energy term.
          </Typography>
	...
	<Typography paragraph align="left">
        ...
        <Typography paragraph>
          <table class="center, w3-table-all">
            ...
            <tr>
              <td>NUMB. OF NEIGHBORS</td>
              <td>Number of cell neighbors</td>
            </tr>
            <tr>
              <td>NUMB. OF VERTEXES</td>
